...
const Summary = () => {
    return (
        <div className='summary'>
            ...
            <div className='pt-5 my-2 justify-content-lg-around align-items-center justify-content-sm-around d-lg-flex d-md-flex px-2 justify-content-md-around w-100'>
                <div className='d-flex justify-content-center align-items-center gap-4'>
                    <MdOutlineAutoStories style={{ fontSize:'60px'}} className='text-success'></MdOutlineAutoStories>
                    <div>
                        <p className='fs-1 fw-semibold'>3000 +</p>
                ...
                <div className='d-flex justify-content-center align-items-center gap-4 my-4'>
                    ...
                    <div>
                        <p className='fs-1 fw-semibold'>150</p>
                ...
                <div className='d-flex justify-content-center align-items-center gap-4'>
                    ...
                    <div>
                        <p className='fs-1 fw-semibold'>1500</p>
                ...
                <div className='d-flex justify-content-center align-items-center gap-4 my-4'>
                    ...
                    <div>
                        <p className='fs-1 fw-semibold'>50</p>
